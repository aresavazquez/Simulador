...
control.controller('Res15CrecienteCtrl', function ($scope, $state, Simula, Avaluos, Calculos, GastosNotariales) {
    ...
    grpBanorte[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpBanorte[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpBanorte[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpBanorte[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    ...
    grpBanorte[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpBanorte[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpBanorte[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpBanorte[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpBanorte[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpBanorte[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
    ...
    grpSantander[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpSantander[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpSantander[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpSantander[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    grpSantander[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(santander.incrementoAnual * 100).toFixed(2) + "%" });
    grpSantander[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpSantander[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpSantander[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpSantander[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpSantander[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpSantander[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpSantander[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
    ...
    grpScotiabank[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpScotiabank[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(scotiabank.incrementoAnual * 100).toFixed(2) + "%" });
    grpScotiabank[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpScotiabank[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpScotiabank[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
    ...
    grpAfirme[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpAfirme[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpAfirme[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpAfirme[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    grpAfirme[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(afirme.incrementoAnual * 100).toFixed(2) + "%" });
    grpAfirme[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpAfirme[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpAfirme[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpAfirme[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpAfirme[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpAfirme[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpAfirme[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
    ...
    grpHSBC[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpHSBC[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpHSBC[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpHSBC[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    grpHSBC[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpHSBC[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpHSBC[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpHSBC[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpHSBC[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpHSBC[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpHSBC[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpHSBC[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
...
control.controller('Res20CrecienteCtrl', function ($scope, $state, Simula, Avaluos, Calculos, GastosNotariales) {
    ...
    grpBancomer[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpBancomer[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpBancomer[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpBancomer[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    ...
    grpBancomer[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpBancomer[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpBancomer[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpBancomer[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpBancomer[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpBancomer[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
...
control.controller('Res15FijoCtrl', function ($scope, $state, Simula, Avaluos, Calculos, GastosNotariales) {
    ...
    grpBanorte[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpBanorte[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpBanorte[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpBanorte[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpBanorte[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpBanorte[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpBanorte[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    ...
    // Santander
    santander = Simula.getForCalc(1, $scope.selMens, $scope.selPlazo);
    var grpSantander = [];
    grpSantander.push({
        name: santander.nombreBanco,
        members: []
    ...
    grpSantander[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpSantander[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpSantander[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpSantander[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpSantander[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpSantander[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpSantander[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    ...
    // Scotiabank
    soctiabank = Simula.getForCalc(1, $scope.selMens, $scope.selPlazo);
    var grpScotiabank = [];
    grpScotiabank.push({
    ...
    grpScotiabank[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpScotiabank[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpScotiabank[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpScotiabank[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpScotiabank[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpScotiabank[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpScotiabank[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    ...
    grpBancomer[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpBancomer[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpBancomer[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpBancomer[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpBancomer[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpBancomer[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpBancomer[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    ...
    // Afirme
    afirme = Simula.getForCalc(1, $scope.selMens, $scope.selPlazo);
    var grpAfirme = [];
    grpAfirme.push({
        name: afirme.nombreBanco,
        members: []
    ...
    grpAfirme[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpAfirme[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpAfirme[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpAfirme[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpAfirme[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpAfirme[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpAfirme[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    ...
    // Banamex
    banamex = Simula.getForCalc(1, $scope.selMens, $scope.selPlazo);
    var grpBanamex = [];
    grpBanamex.push({
    ...
    grpBanamex[0].members.push({ name: "Pago mensual", quantity: parseFloat(pagoMensual).toFixed(2) });
    grpBanamex[0].members.push({ name: "Monto del credito", quantity: parseFloat(montoCredito).toFixed(2) });
    grpBanamex[0].members.push({ name: "Tasa de interes", quantity: (tasaInteres * 100).toFixed(2) + '%' });
    grpBanamex[0].members.push({ name: "Ingreso requerido", quantity: parseFloat(ingresoRequerido).toFixed(2) });
    //grpBanamex[0].members.push({ name: "Incremento anual del pago", quantity: parseFloat(hsbc.incrementoAnual * 100).toFixed(2) + "%" });
    grpBanamex[0].members.push({ name: "CAT", quantity: (cat * 100).toFixed(2) + '%' });
    grpBanamex[0].members.push({ name: "Gastos del credito", quantity: "" });
    grpBanamex[0].members.push({ name: "Enganche", quantity: parseFloat(enganche).toFixed(2) });
    grpBanamex[0].members.push({ name: "Avaluo", quantity: parseFloat(avaluo).toFixed(2) });
    grpBanamex[0].members.push({ name: "Comision por apertura", quantity: parseFloat(comisionApertura).toFixed(2) });
    grpBanamex[0].members.push({ name: "Gastos notariales", quantity: parseFloat(gastosNotariales).toFixed(2) });
    grpBanamex[0].members.push({ name: "Desembolso total", quantity: parseFloat(desembolsoTotal).toFixed(2) });
    ...
    // HSBC
    hsbc = Simula.getForCalc(1, $scope.selMens, $scope.selPlazo);
    var grpHSBC = [];
    grpHSBC.push({
        name: hsbc.nombreBanco,
        members: []
