(function () {
    ...
    control.controller('Res20FijoCtrl', function ($scope, $state, $ionicPopup,
        ...
        $http({
            ...
            $scope.data.simBanorte = grpBanorte;
        }).error(function (res) {
        ...
        $http({
            ...
            $scope.data.simSantander = grpSantander;
        }).error(function (res) {
            console.log("error de conexión server")
        });
        ////////////////////////////////////////////////////
        ...
        $http({
            ...
            $scope.data.simScotia = grpScotiabank;
        }).error(function (res) {
            console.log("error de conexión server")
        });
        ////////////////////////////////////////////////////
        ...
        $http({
            ...
            $scope.data.simBancomer = grpBancomer;
        }).error(function (res) {
            console.log("error de conexión server")
        });
        ////////////////////////////////////////////////////
        ...
        $http({
            ...
            $scope.data.simAfirme = grpAfirme;
        }).error(function (res) {
            console.log("error de conexión server")
        });
        ////////////////////////////////////////////////////
        ...
        $http({
            ...
            $scope.data.simBanamex = grpBanamex;
        }).error(function (res) {
            console.log("error de conexión server")
        });
        ////////////////////////////////////////////////////
