(function () {
        ...
        return {
            ...
            get: function (prospectoId) {
                for (var i = 0; i < prospectos.length; i++) {
                    if (prospectos[i].id === prospectoId) {
                        return prospectos[i];
                    }
                }
                return undefined;
            ...
            getByDate:function(date){
                var res = [];
                for (var i = 0; i < prospectos.length; i++){
                    if (prospectos[i].fecha.indexOf(date)>-1) {
                        res.push(prospectos[i]);
                    }
                }
                return res;
            },
            getByName: function (nombre) {
                var res = [];
                for (var i = 0; i < prospectos.length; i++) {
                    if (prospectos[i].nombre.indexOf(nombre) > -1) {
                        res.push(prospectos[i]);
                    }
                }
                return res;
    ...
    serv.factory('GastosNotariales', function () {
        var gastos = [
    ...
    serv.factory('Calculos', function () {
        return {
